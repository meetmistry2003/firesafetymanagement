...
.header {
    ...
    <body>
        ...
        <table border="1" align="center" style="width:50%">
                ...
                <tr>
                    <th><h2><b>MOBILE NUMBER  <input type="number" placeholder="Enter the NUMBER" class="search" name="es" id="es" maxlength="10"/></b></h2></th>
                </tr>
                <tr>
...
// ALTER TABLE cust_det AUTO_INCREMENT=1;
	...
	<th class="text-center"><?php echo $row['number'];  ?></th>
	</tr>
	<?php
		// $cname= $row['cname'];
		// $amount= $row['estimate'];
